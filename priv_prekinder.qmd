...
-   **Fuente principal de datos:** Centro de Estudios Mineduc
...
Para el caso chileno, se filtró la base de datos, eligiendo en el campo: “dependencia” los valores 2 y 3, que corresponden a aquellos establecimientos que requieren de un pago, que son: particular subvencionado o particular pagado, tal como se indica en la Tabla N° [-@tbl-preKinderEst]
...
La base de datos, obtenida desde el centro de estudios del MINEDUC, 2024, traía información de todos los establecimientos de Chile. Como primer filtro se seleccionó sólo los pertenecientes a la Región Metropolitana, luego sólo los privados y subvencionado y luego que pertenecieran a la nivel 2, medio mayor. 
...
Se utilizó la fórmula de cálculo de accesibilidad correspondiendo de manera de forma resumida una oferta por una demanda, todo esto ponderado por un factor de accesibilidad dado por el costo de desplazamiento en función de la distancia, como se observa en la ecuación [-@eq-prekiderPriv].
