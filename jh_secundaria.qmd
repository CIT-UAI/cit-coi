...
**Valor alto**: Alta proporción de hogares con capital educativo intermedio. Puede representar territorios en transición o con base educativa suficiente para ciertos niveles de empleabilidad.

**Valor bajo**: Poca presencia de escolaridad media en jefes/as de hogar, asociado a rezago educativo estructural o concentración de extremos (primaria o superior).
